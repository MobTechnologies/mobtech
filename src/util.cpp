...
const char * const BITCOIN_CONF_FILENAME = "mobtech.conf";
const char * const BITCOIN_PID_FILENAME = "mobtechd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mobtech";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mobtech";
#else
    // Unix
    return pathRet / ".mobtech";
#endif
#endif
}
