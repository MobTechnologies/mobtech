...
{
    const char* pszTimestamp = "Mobile Technologies 2019";
...
public:
    CMainParams() {
        ...
        consensus.nStakeMinAge = 2.5 * 60 * 60;
        ...
        genesis = CreateGenesisBlock(1560431000, 13665, 0x1f00ffff, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0000abdd4a7c06c2ad8b32ba25a561be84a3f24ce466e6b476087e65834d04b2"));
        ...
        nCollateralLevels = { 5000000 };
        nPoolMaxTransactions = 3;
        nFulfilledRequestExpireTime = 60*60;
        strSporkPubKey = "0336855fdcb4fbdd7ac48686870063c434df1e5febc05310a208fd1e0e56f8d500";
